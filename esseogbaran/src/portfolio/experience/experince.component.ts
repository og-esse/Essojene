  ...
  experiences = [
    {
      ...
      description: [
        'Lead backend and platform development for the Investments Mega Journey, designing Java/Spring Boot REST APIs with contract-first request/response schemas for tax-savings calculations and returning-user state determination.',
        'Built middleware orchestration that adapts internal tax-projection requests into a third-party calculation engine format, then maps responses back into internal DTOs and MongoDB documents.',
        'Secured service endpoints with OAuth2 resource-server/JWT authentication and externalized secrets through HashiCorp Vault.',
        'Implemented retry, exponential backoff, and centralized exception handling for downstream service calls to improve resilience under partial failures.',
        'Maintained 80% JaCoCo test coverage using Mockito unit tests and WireMock-backed integration tests for downstream service behavior.',
